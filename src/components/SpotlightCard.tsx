...
export default function SpotlightCard({ children, className = '' }: { children: React.ReactNode, className?: string }) {
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden rounded-3xl border border-white/5 bg-white/5 backdrop-blur-md transition-colors hover:border-primary/30 group ${className}`}
    >
      <div
